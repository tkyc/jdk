 ...
 * Signature: (III)V
 */
JNIEXPORT void JNICALL Java_jdk_net_WindowsSocketOptions_setTcpKeepAlive
(JNIEnv *env, jobject unused, jint fd, jint keepAliveTime, jint keepAliveIntvl) {
    ...
    rv = WSAIoctl(fd, SIO_KEEPALIVE_VALS, &keepalive, sizeof(keepalive), NULL, 0, &dwBytesRet, NULL, NULL);
